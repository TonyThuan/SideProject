...
//////// Fuses: IESO,NOIESO,PUT,NOPUT,BROWNOUT,NOBROWNOUT,BORV45,BORV42
//////// Fuses: BORV27,BORV20,WDT,NOWDT,WDT1,WDT2,WDT4,WDT8,WDT16,WDT32
//////// Fuses: WDT64,WDT128,WDT256,WDT512,WDT1024,WDT2048,WDT4096,WDT8192
//////// Fuses: WDT16384,WDT32768,WINEN,NOWINEN,PWMPIN,NOPWMPIN,LPOL_LOW
//////// Fuses: LPOL_HIGH,HPOL_LOW,HPOL_HIGH,T1STANDARD,T1LOWPOWER,FLTAD4
//////// Fuses: FLTAC1,SSP_RD,SSP_RC,PWM4D5,PWM4B5,EXCLKD0,EXCLKC3,MCLR
//////// Fuses: NOMCLR,STVREN,NOSTVREN,LVP,NOLVP,DEBUG,NODEBUG,PROTECT
...
// Constants used in setup_qei() first parameter are:
...
// Constants used in setup_qei() second parameter are:  // Third parameter is MAXCOUNT
...
////////////////////////////////////////////////////////////////// Motion Feedback (MF) Input Capture (IC)
// MF IC Functions: setup_mf_capture(), get_mf_capture()
//
// MF IC Prototypes:
_bif void setup_mf_capture(int8 module, int8 mode);
_bif int16 get_mf_capture(int8 module);
// Constants used in setup_mf_capture() second parameter, first parameter is module 1-3, are:
#define MF_CAPTURE_DISABLED          0x00
#define MF_CAPTURE_FE                0x41
#define MF_CAPTURE_RE                0x42
#define MF_CAPTURE_DIV_4             0x43 //Capture every 4th rising edge
#define MF_CAPTURE_DIV_16            0x44 //Capture every 16th rising edge
#define MF_CAPTURE_FREQ_MODE_RE      0x45 //Frequency Measurement mode, every rising edge
#define MF_CAPTURE_PW_MODE_FE_TO_RE  0x46 //Pulse-Width Measurement mode, every falling to rising edge
#define MF_CAPTURE_PW_MODE_RE_TO_FE  0x47 //Pulse-Width Measurement mode, every rising to falling edge
#define MF_CAPTURE_EE                0x48 //Capture on every CAPx input state change
#define MF_CAPTURE_TRIGGER_FE        0x4E //Special Event Trigger mode, every rising edge.  IC1 only
#define MF_CAPTURE_TRIGGER_RE        0x4F //Special Event Trigger mode, every falling edge.  IC1 only
...
// This device allows 4 parameters to set_adc_channel to set the channel
